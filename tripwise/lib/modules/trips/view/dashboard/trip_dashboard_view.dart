...
import 'package:tripwise/modules/trips/view/settings/trip_settings_view.dart';

class TripDashboardView extends StatelessWidget {
  final Trip trip;

  const TripDashboardView({super.key, required this.trip});
