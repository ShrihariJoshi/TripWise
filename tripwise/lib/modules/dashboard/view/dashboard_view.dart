...
import 'package:tripwise/modules/trips/view/trip_detail_view.dart';
import 'package:tripwise/modules/trips/view/widgets/create_trip_sheet.dart';
import 'package:tripwise/modules/dashboard/controller/dashboard_controller.dart';
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Trip Expense List from API
                  Obx(() {
                    if (dashboardController.isLoadingExpenses.value) {
                      return const Center(
                        child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  dashboardController.refreshExpenses(),
                              color: Colors.red.shade700,
                            ),
                          ],
                        ),
                    ...
                    final expenses = dashboardController.userExpenses;
                    ...
                    return Column(
                      children: expenses
                          .map(
                            (expense) => _TripExpenseCard(
                              tripName: expense.tripName,
                              netAmount: expense.netBalance.abs(),
...
class _TripExpenseCard extends StatelessWidget {
  ...
  final bool isOwed; // false if you owe, true if you're owed
          ...
          children: [
            ...
            Container(
              ...
              child: Icon(
                ...
                color: isOwed ? const Color(0xff4CAF50) : Colors.red,
                size: 22,
              ),
            ),
            ...
            Column(
              ...
              children: [
                robotoText(
                  "${isOwed ? '+' : '-'}₹${netAmount.toStringAsFixed(2)}",
                  fontSize: 17,
                  fontWeight: FontWeight.bold,
                  color: isOwed ? const Color(0xff4CAF50) : Colors.red.shade700,
                ),
                const SizedBox(height: 4),
                Container(
                  padding: const EdgeInsets.symmetric(
